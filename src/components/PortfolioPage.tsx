  ...
  const projects = [
    {
      ...
      image: (
        <ImageWithFallback
          src= "/images/Maison_elegant.png"
          alt="E-commerce Moda Italiana"
        />
      ),
      imageUrl: "/images/Maison_elegant.png", 
    ...
    },
    {
      ...
      image: (
        <ImageWithFallback
        src= "/images/tokenclub.png"  
        alt="Dashboard Gestionale ERP"
        />
      ),
      imageUrl: "/images/tokenclub.png",
    ...
    },
    {
      ...
      image: (
        <ImageWithFallback
        src= "/images/ubunye.png"  
        alt="Sito Web Guida"
        />
      ),
      imageUrl: "/images/ubunye.png"  ,
    ...
    },
    {
      ...
      image: (
        ...
        alt="Piattaforma Gestionale PA"
        />
      ),
      imageUrl: "/images/termo.png",
    ...
    <div className="min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-16">
          <h1 className="text-4xl lg:text-5xl">Portfolio</h1>
