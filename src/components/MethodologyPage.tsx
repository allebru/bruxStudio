    ...
    <div className="min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          <h1 className="text-4xl lg:text-5xl">Metodologia BRUX</h1>
        ...
        <section className="mb-20">
          <h2 className="text-3xl text-center mb-12">Le Quattro Fasi del Framework</h2>
                    ...
                    <Card className="border border-border">
                      ...
                      <CardContent className="space-y-6">
                        <div className="grid md:grid-cols-2 gap-6">
                          <div>
                            <h4 className="text-sm mb-3 text-muted-foreground">Attività Principali</h4>
                          ...
                          <div>
                            <h4 className="text-sm mb-3 text-muted-foreground">Deliverables</h4>
                            <ul className="space-y-2">
        ...
        {/* Benefits */}
        <section className="mb-20">
          <h2 className="text-3xl text-center mb-12">Vantaggi del Framework BRUX</h2>
        ...
        <section className="mb-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl mb-6">Fattori di Successo</h2>
